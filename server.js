...
async function eseguiTiroDadiPerGiocatore(
  ...
  /*
   * Fermiamo il timer del turno attuale.
   * NON cambiamo ancora giocatore.
   */
  fermaTimerTurno(
    partita
  );
  ...
  try {
     ...
     *
     * Il giocatore attuale rimane
     * il giocatore attivo durante
     * l'intera animazione.
     */

    const idTurnoDuranteAnimazione =
      partita.ordineGiocatori[
        partita.turnoAttuale
      ];

    const statoDuranteAnimazione =
    ...
    if (
      ...
      /*
       * La vittoria non aspetta un altro turno.
       * Diamo comunque tempo al client di
       * completare visivamente il risultato.
       */
      setTimeout(
        async () => {
          const trovato =
    ...
    /*
     * Aspettiamo che l'animazione sia realmente
     * terminata.
     */
    setTimeout(
      async () => {
        ...
        /*
         * SOLO ORA decidiamo se:
         *
         * - resta lo stesso giocatore
         *   per un tiro extra
         *
         * - oppure passa al prossimo.
         */
        if (
          !risultato.tiraAncora &&
          !risultato.vittoria
    ...
    /*
     * Se RANDOM.ORG fallisce,
     * non lasciamo la partita
     * con il tiro "bloccato".
     */
    partita.animazioneTiroInCorso =
      false;
...
/* =========================================================
   INATTIVITÀ / ABBANDONO AUTOMATICO
========================================================= */
        ...
        try {
          ...
          if (
            ...
            if (
               ...
               * il nuovo giocatore deve avere
               * un turno completo.
               *
               * Qui NON cambiamo ulteriormente
               * il turno: l'indice è già stato
               * sistemato sopra.
               */
              if (
                eraLuiIlGiocatoreAttivo
