...
let suoniAttivi =
    localStorage.getItem("suoniAttivi") !== "off";
...
function eSchermoInLandscape() {
    if (
        ...
        typeof window.screen.orientation.type ===
            "string"
    ) {
        const orientamento =
        ...
        dati.ordineGiocatori
            .map(
                (nome, indice) => {
                    ...
                    return `
                        <div
                            class="determinazione-riga determinazione-riga-finale"
        ...
        (giocatore, indice) => {
            ...
            if (
                ...
                if (
                    ...
                    audioHtml =
                        `<button class="btn-chiama-audio" title="Chiedi di parlare" onclick="richiediAudioCon('${uid}')">📞</button>`;
                }
            }
            ...
            card.innerHTML = `
                ...
                <a
                    href="profilo-pubblico.html?nickname=${encodeURIComponent(giocatore.nome)}"
                    target="_blank"
                    rel="noopener"
