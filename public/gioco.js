      ...
      .map((g) => {
        ...
        const avatarHtml =
          g.avatar
            ...
            : `<div
                class="avatar-mini"
                style="background:${coloreDaNome(g.nome)};"
              >
                ${iniziale(g.nome)}
              </div>`;
        ...
        if (
          ...
          statoHtml =
            `<span class="determinazione-in-corso">
              🎲 sta tirando...
            </span>`;
          ...
          statoHtml =
            `<span class="determinazione-attesa">
              in attesa
            </span>`;
        ...
        const tagSpareggio =
          spareggioSet.has(g.uid)
            ...
            ? `<span
                class="determinazione-tag-spareggio"
                title="In spareggio"
              >
                ⚔️
              </span>`
    ...
    (
      ...
      if (
        ...
        if (
          ...
          audioHtml =
            `<span
              class="stato-audio attivo"
              title="Chiamata attiva"
            >
              🎤
            </span>`;
          ...
          audioHtml =
            `<button
              type="button"
              class="btn-chiama-audio"
              title="Chiedi di parlare"
              onclick="richiediAudioCon('${String(
                giocatore.id
              ).replace(
                /'/g,
                "\\'"
